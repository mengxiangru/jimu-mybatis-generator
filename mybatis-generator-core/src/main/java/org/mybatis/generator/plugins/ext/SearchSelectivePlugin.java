 ...
 */
public class SearchSelectivePlugin extends AbstractPluginAdapter {
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        interfaze.addMethod(generateSearchSelective(introspectedTable));
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        ...
        answer.addAttribute(new Attribute("id", "search" + introspectedTable.getTableConfiguration().getDomainObjectName())); //$NON-NLS-1$
    ...
    private Method generateSearchSelective(IntrospectedTable introspectedTable) {

        Method m = new Method("search" + introspectedTable.getTableConfiguration().getDomainObjectName());
